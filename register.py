...
class Register:
    def __init__(self,root):
        ...
        # === Bg Image===
        self.bg=ImageTk.PhotoImage(file="D:\Loginimages\WhatsApp Image 2025-07-01 at 5.04.25 PM.jpeg")
        bg=Label(self.root,image=self.bg).place(x=283,y=0,relwidth=1,relheight=1)

        #=== LEFT image===
        self.left=ImageTk.PhotoImage(file="D:\Loginimages\WhatsApp Image 2025-07-01 at 4.38.24 PM.jpeg")
        left=Label(self.root,image=self.left).place(x=165,y=100,width=400,height=600)

        # ========Register Frame =============
        frame1=Frame(self.root,bg="white")
        frame1.place(x=600,y=100,width=700,height=500)
        ...
        self.cmb_quest['values']=("Select","Your First pet Name","Your Birth Place","Your Best Friend Name","Your Gf Name","Your College Name","Your City Name")
        ...
        btn_register=Button(frame1,text="Register Now ------>",bg="lightgreen",bd=0,font=("times new roman",15,"bold"),cursor="hand2",command=self.register_data).place(x=50,y=420)
        # -------- Sign In Button-----------
        btn_login=Button(self.root,text="Sign in",bg="lightyellow",bd=0,font=("times new roman",20),cursor="hand2").place(x=290,y=390,width=180)
