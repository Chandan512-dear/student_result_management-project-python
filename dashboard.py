...
class RMS:
    def __init__(self,root):
        ...
        #===icons====#
        self.logo_dash=ImageTk.PhotoImage(file="D:\RMS(PROJECT)\__pycache__\icon.png") 
        ...
        # ===content window ====
        self.ICON2_img=Image.open("D:\RMS(PROJECT)\ICON3.jpg")
        self.ICON2_img=self.ICON2_img.resize((920,350))
        self.ICON2_img=ImageTk.PhotoImage(self.ICON2_img)

        self.lbl_bg=Label(self.root,image=self.ICON2_img).place(x=400,y=180,width=920,height=350)
        ...
        #===footer=====#
        footer = Label(self.root,text="SRMS - Student Result Management System\nContact us for any Technical Issue: 9874xxxx01",font=("goudy old style",12),bg="#262626",fg="white").pack(side=BOTTOM,fill=X)
    def add_course(self):
